...
<div class="card">
    ...
    <div class="form-group">
        ...
        {!! Form::select('tamaño_id', $tamaño,['class'=>'form-control']) !!}
        @error('tamaño_id')
            <span class="taxt-danger">{{$message}}</span>
        @enderror
    </div>
    <div class="text-center mb-5">
        <img id="picture" class="img-fluid text-center" src="{{Storage::url($producto->image->url)}}" alt="">
    </div>
    <div>
        <div>
    ...
    {{-- <div class="form-group">
        {!! Form::label('image','Imagen',['class'=>'block text-sm font-medium text-gray-700']) !!}
